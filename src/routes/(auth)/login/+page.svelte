...
<div class="mx-auto max-w-md">
	<section class="py-12">
		...
		<form method="post" use:enhance={handleSubmit} class="mt-8">
			<div class="grid grid-cols-1 gap-6">
				...
				<div class="flex items-center">
					<Button disabled={isLoading} type="submit" classes="button primary">Sign in</Button>
					{#if isLoading}
		...
		<div class="mt-6">
			<p>
				Forgot your password? <Button href="/forgot-password" classes="underline"
					>Choose a new one</Button
				>
			</p>
		</div>
	</section>
